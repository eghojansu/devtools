...
<body>
    ...
    <?php else: ?>
        ...
        <table class="table">
            <thead>
                <tr>
                    <th width="200px" id="checked-database">Databases</th>
                    <th width="200px">Tables &amp; Views</th>
                    <th width="200px" id="checked-column">Columns</th>
                    <th>tools</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>
                        <ol class="db-item database" data-target="#checked-database">
                    ...
                    <td>
                        <p><em id="checked-table">Tables</em></p>
                        <ol class="db-item table" data-target="#checked-table">
                            <?php foreach ($tableList as $key => $value): ?>
                                <li><?php echo h::checkbox('table[]').' '.h::a($value, ['class'=>$value===$table?'active':''], ['table'=>$value]); ?></li>
                            <?php endforeach; ?>
                        </ol>
                        <p><em id="checked-view">Views</em></p>
                        <ol class="db-item view" data-target="#checked-view">
                    ...
                    <td>
                        <ol class="db-item column" data-target="#checked-column">
